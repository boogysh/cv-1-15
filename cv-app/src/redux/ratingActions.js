...
export const SET_RATING_FULL_UPDATE = "SET_RATING_FULL_UPDATE";

export const setRatingFullUpdate = (projectId, rating, average, count) => ({
  type: SET_RATING_FULL_UPDATE,
  payload: { projectId, rating, average, count },
});
